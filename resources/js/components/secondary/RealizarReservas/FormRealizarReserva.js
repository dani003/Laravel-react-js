      ...
      <div>
        <div className='FormCancelarReservaBox'>
          <div className=" bp3-card bp3-interactive bp3-elevation-3 FormCancelarReservaBoxCard">
            <div>
              <img className="imagenCalendario" src="https://png.pngtree.com/svg/20170417/experiment_644708.png"></img>
            </div>
            <div className="infodisp">
              <div className="Nombredisp FormReserva" >
                ...
                <Link to="/">
                <button type="button" class="bp3-button bp3-icon-add BotonReserva bp3-intent-success">Ir A Realizar reserva</button>
              </Link>
                <Link to="/">
